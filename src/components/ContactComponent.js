...
import { Breadcrumb, BreadcrumbItem, Button, FormGroup, Form, Label, Input, Col, FormFeedback, Row } from 'reactstrap';
                    ...
                    <div className="col-12 col-md-9">
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".message" id="message" rows="6" name="message"
                                        className="form-control" />
                                </Col>
                            </Row>
                            <Row className="form-group">
